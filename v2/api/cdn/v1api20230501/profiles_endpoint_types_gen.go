...
// +kubebuilder:webhook:path=/mutate-cdn-azure-com-v1api20230501-profilesendpoint,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=cdn.azure.com,resources=profilesendpoints,verbs=create;update,versions=v1api20230501,name=default.v1api20230501.profilesendpoints.cdn.azure.com,admissionReviewVersions=v1
...
// +kubebuilder:webhook:path=/validate-cdn-azure-com-v1api20230501-profilesendpoint,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=cdn.azure.com,resources=profilesendpoints,verbs=create;update,versions=v1api20230501,name=validate.v1api20230501.profilesendpoints.cdn.azure.com,admissionReviewVersions=v1
