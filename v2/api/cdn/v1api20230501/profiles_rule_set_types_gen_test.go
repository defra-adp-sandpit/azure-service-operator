...
func Test_ProfilesRuleSet_WhenConvertedToHub_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties.Property(
		"Round trip from ProfilesRuleSet to hub returns original",
		prop.ForAll(RunResourceConversionTestForProfilesRuleSet, ProfilesRuleSetGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunResourceConversionTestForProfilesRuleSet tests if a specific instance of ProfilesRuleSet round trips to the hub storage version and back losslessly
func RunResourceConversionTestForProfilesRuleSet(subject ProfilesRuleSet) string {
	// Copy subject to make sure conversion doesn't modify it
	copied := subject.DeepCopy()

	// Convert to our hub version
	var hub v20230501s.ProfilesRuleSet
...
func Test_ProfilesRuleSet_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MaxSize = 10
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from ProfilesRuleSet to ProfilesRuleSet via AssignProperties_To_ProfilesRuleSet & AssignProperties_From_ProfilesRuleSet returns original",
		prop.ForAll(RunPropertyAssignmentTestForProfilesRuleSet, ProfilesRuleSetGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForProfilesRuleSet tests if a specific instance of ProfilesRuleSet can be assigned to v1api20230501storage and back losslessly
func RunPropertyAssignmentTestForProfilesRuleSet(subject ProfilesRuleSet) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20230501s.ProfilesRuleSet
	err := copied.AssignProperties_To_ProfilesRuleSet(&other)
	if err != nil {
		return err.Error()
	}
	...
	var actual ProfilesRuleSet
	err = actual.AssignProperties_From_ProfilesRuleSet(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_ProfilesRuleSet_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of ProfilesRuleSet via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForProfilesRuleSet, ProfilesRuleSetGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForProfilesRuleSet runs a test to see if a specific instance of ProfilesRuleSet round trips to JSON and back losslessly
func RunJSONSerializationTestForProfilesRuleSet(subject ProfilesRuleSet) string {
	// Serialize to JSON
...
// Generator of ProfilesRuleSet instances for property testing - lazily instantiated by ProfilesRuleSetGenerator()
var profilesRuleSetGenerator gopter.Gen

// ProfilesRuleSetGenerator returns a generator of ProfilesRuleSet instances for property testing.
func ProfilesRuleSetGenerator() gopter.Gen {
	if profilesRuleSetGenerator != nil {
		return profilesRuleSetGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddRelatedPropertyGeneratorsForProfilesRuleSet(generators)
	profilesRuleSetGenerator = gen.Struct(reflect.TypeOf(ProfilesRuleSet{}), generators)

	return profilesRuleSetGenerator
}

// AddRelatedPropertyGeneratorsForProfilesRuleSet is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForProfilesRuleSet(gens map[string]gopter.Gen) {
...
// RunPropertyAssignmentTestForProfiles_RuleSet_Spec tests if a specific instance of Profiles_RuleSet_Spec can be assigned to v1api20230501storage and back losslessly
...
// RunPropertyAssignmentTestForProfiles_RuleSet_STATUS tests if a specific instance of Profiles_RuleSet_STATUS can be assigned to v1api20230501storage and back losslessly
