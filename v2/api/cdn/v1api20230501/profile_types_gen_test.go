...
// RunPropertyAssignmentTestForProfile tests if a specific instance of Profile can be assigned to v1api20230501storage and back losslessly
...
// RunPropertyAssignmentTestForProfile_Spec tests if a specific instance of Profile_Spec can be assigned to v1api20230501storage and back losslessly
...
// RunPropertyAssignmentTestForProfile_STATUS tests if a specific instance of Profile_STATUS can be assigned to v1api20230501storage and back losslessly
...
// RunPropertyAssignmentTestForManagedServiceIdentity tests if a specific instance of ManagedServiceIdentity can be assigned to v1api20230501storage and back losslessly
...
// RunPropertyAssignmentTestForManagedServiceIdentity_STATUS tests if a specific instance of ManagedServiceIdentity_STATUS can be assigned to v1api20230501storage and back losslessly
...
// RunPropertyAssignmentTestForSku tests if a specific instance of Sku can be assigned to v1api20230501storage and back losslessly
...
// RunPropertyAssignmentTestForSku_STATUS tests if a specific instance of Sku_STATUS can be assigned to v1api20230501storage and back losslessly
...
// RunPropertyAssignmentTestForSystemData_STATUS tests if a specific instance of SystemData_STATUS can be assigned to v1api20230501storage and back losslessly
...
// RunPropertyAssignmentTestForUserAssignedIdentity_STATUS tests if a specific instance of UserAssignedIdentity_STATUS can be assigned to v1api20230501storage and back losslessly
...
// RunPropertyAssignmentTestForUserAssignedIdentityDetails tests if a specific instance of UserAssignedIdentityDetails can be assigned to v1api20230501storage and back losslessly
