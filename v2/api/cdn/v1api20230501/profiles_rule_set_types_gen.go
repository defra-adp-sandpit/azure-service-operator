...
var _ conditions.Conditioner = &ProfilesRuleSet{}

// GetConditions returns the conditions of the resource
func (ruleSet *ProfilesRuleSet) GetConditions() conditions.Conditions {
	return ruleSet.Status.Conditions
}

// SetConditions sets the conditions on the resource status
func (ruleSet *ProfilesRuleSet) SetConditions(conditions conditions.Conditions) {
	ruleSet.Status.Conditions = conditions
}

var _ conversion.Convertible = &ProfilesRuleSet{}

// ConvertFrom populates our ProfilesRuleSet from the provided hub ProfilesRuleSet
func (ruleSet *ProfilesRuleSet) ConvertFrom(hub conversion.Hub) error {
	source, ok := hub.(*v20230501s.ProfilesRuleSet)
	if !ok {
		return fmt.Errorf("expected cdn/v1api20230501storage/ProfilesRuleSet but received %T instead", hub)
	}

	return ruleSet.AssignProperties_From_ProfilesRuleSet(source)
}

// ConvertTo populates the provided hub ProfilesRuleSet from our ProfilesRuleSet
func (ruleSet *ProfilesRuleSet) ConvertTo(hub conversion.Hub) error {
	destination, ok := hub.(*v20230501s.ProfilesRuleSet)
	if !ok {
		return fmt.Errorf("expected cdn/v1api20230501storage/ProfilesRuleSet but received %T instead", hub)
	}

	return ruleSet.AssignProperties_To_ProfilesRuleSet(destination)
}

// +kubebuilder:webhook:path=/mutate-cdn-azure-com-v1api20230501-profilesruleset,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=cdn.azure.com,resources=profilesrulesets,verbs=create;update,versions=v1api20230501,name=default.v1api20230501.profilesrulesets.cdn.azure.com,admissionReviewVersions=v1

var _ admission.Defaulter = &ProfilesRuleSet{}

// Default applies defaults to the ProfilesRuleSet resource
func (ruleSet *ProfilesRuleSet) Default() {
	ruleSet.defaultImpl()
...
func (ruleSet *ProfilesRuleSet) defaultAzureName() {
	if ruleSet.Spec.AzureName == "" {
		ruleSet.Spec.AzureName = ruleSet.Name
	}
}

// defaultImpl applies the code generated defaults to the ProfilesRuleSet resource
func (ruleSet *ProfilesRuleSet) defaultImpl() { ruleSet.defaultAzureName() }

var _ genruntime.ImportableResource = &ProfilesRuleSet{}

// InitializeSpec initializes the spec for this resource from the given status
func (ruleSet *ProfilesRuleSet) InitializeSpec(status genruntime.ConvertibleStatus) error {
...
var _ genruntime.KubernetesResource = &ProfilesRuleSet{}

// AzureName returns the Azure name of the resource
func (ruleSet *ProfilesRuleSet) AzureName() string {
	return ruleSet.Spec.AzureName
}

// GetAPIVersion returns the ARM API version of the resource. This is always "2023-05-01"
func (ruleSet ProfilesRuleSet) GetAPIVersion() string {
	return string(APIVersion_Value)
}

// GetResourceScope returns the scope of the resource
func (ruleSet *ProfilesRuleSet) GetResourceScope() genruntime.ResourceScope {
	return genruntime.ResourceScopeResourceGroup
}

// GetSpec returns the specification of this resource
func (ruleSet *ProfilesRuleSet) GetSpec() genruntime.ConvertibleSpec {
	return &ruleSet.Spec
}

// GetStatus returns the status of this resource
func (ruleSet *ProfilesRuleSet) GetStatus() genruntime.ConvertibleStatus {
	return &ruleSet.Status
}

// GetType returns the ARM Type of the resource. This is always "Microsoft.Cdn/profiles/ruleSets"
func (ruleSet *ProfilesRuleSet) GetType() string {
	return "Microsoft.Cdn/profiles/ruleSets"
}

// NewEmptyStatus returns a new empty (blank) status
func (ruleSet *ProfilesRuleSet) NewEmptyStatus() genruntime.ConvertibleStatus {
	return &Profiles_RuleSet_STATUS{}
}

// Owner returns the ResourceReference of the owner
func (ruleSet *ProfilesRuleSet) Owner() *genruntime.ResourceReference {
	group, kind := genruntime.LookupOwnerGroupKind(ruleSet.Spec)
	return ruleSet.Spec.Owner.AsResourceReference(group, kind)
}

// SetStatus sets the status of this resource
func (ruleSet *ProfilesRuleSet) SetStatus(status genruntime.ConvertibleStatus) error {
...
// +kubebuilder:webhook:path=/validate-cdn-azure-com-v1api20230501-profilesruleset,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=cdn.azure.com,resources=profilesrulesets,verbs=create;update,versions=v1api20230501,name=validate.v1api20230501.profilesrulesets.cdn.azure.com,admissionReviewVersions=v1

var _ admission.Validator = &ProfilesRuleSet{}

// ValidateCreate validates the creation of the resource
func (ruleSet *ProfilesRuleSet) ValidateCreate() (admission.Warnings, error) {
...
func (ruleSet *ProfilesRuleSet) ValidateDelete() (admission.Warnings, error) {
...
func (ruleSet *ProfilesRuleSet) ValidateUpdate(old runtime.Object) (admission.Warnings, error) {
...
func (ruleSet *ProfilesRuleSet) createValidations() []func() (admission.Warnings, error) {
	return []func() (admission.Warnings, error){ruleSet.validateResourceReferences, ruleSet.validateOwnerReference}
}

// deleteValidations validates the deletion of the resource
func (ruleSet *ProfilesRuleSet) deleteValidations() []func() (admission.Warnings, error) {
	return nil
}

// updateValidations validates the update of the resource
func (ruleSet *ProfilesRuleSet) updateValidations() []func(old runtime.Object) (admission.Warnings, error) {
...
func (ruleSet *ProfilesRuleSet) validateOwnerReference() (admission.Warnings, error) {
	return genruntime.ValidateOwner(ruleSet)
}

// validateResourceReferences validates all resource references
func (ruleSet *ProfilesRuleSet) validateResourceReferences() (admission.Warnings, error) {
...
func (ruleSet *ProfilesRuleSet) validateWriteOnceProperties(old runtime.Object) (admission.Warnings, error) {
	oldObj, ok := old.(*ProfilesRuleSet)
	if !ok {
		return nil, nil
	}
...
// AssignProperties_From_ProfilesRuleSet populates our ProfilesRuleSet from the provided source ProfilesRuleSet
func (ruleSet *ProfilesRuleSet) AssignProperties_From_ProfilesRuleSet(source *v20230501s.ProfilesRuleSet) error {
...
// AssignProperties_To_ProfilesRuleSet populates the provided destination ProfilesRuleSet from our ProfilesRuleSet
func (ruleSet *ProfilesRuleSet) AssignProperties_To_ProfilesRuleSet(destination *v20230501s.ProfilesRuleSet) error {
...
func (ruleSet *ProfilesRuleSet) OriginalGVK() *schema.GroupVersionKind {
	return &schema.GroupVersionKind{
		Group:   GroupVersion.Group,
		Version: ruleSet.Spec.OriginalVersion(),
		Kind:    "ProfilesRuleSet",
	}
}
...
// - Generated from: /cdn/resource-manager/Microsoft.Cdn/stable/2023-05-01/afdx.json
// - ARM URI: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Cdn/profiles/{profileName}/ruleSets/{ruleSetName}
type ProfilesRuleSetList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []ProfilesRuleSet `json:"items"`
}
...
func init() {
	SchemeBuilder.Register(&ProfilesRuleSet{}, &ProfilesRuleSetList{})
}
