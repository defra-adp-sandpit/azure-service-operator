...
// +kubebuilder:rbac:groups=cdn.azure.com,resources=profilesrulesets,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=cdn.azure.com,resources={profilesrulesets/status,profilesrulesets/finalizers},verbs=get;update;patch
...
// Storage version of v1api20230501.ProfilesRuleSet
...
// Hub marks that this ProfilesRuleSet is the hub type for conversion
func (ruleSet *ProfilesRuleSet) Hub() {}
